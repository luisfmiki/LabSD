...
entity elevador is
    port(
        clk, A0_f, A0_d, A1_f, A1_d, A2_f, A2_d, S_porta, S_andar, B_abre, B_fecha, B_alarme : in std_logic;
        M_out: out std_logic_vector (3 downto 0);
        LED_out: out std_logic_vector (6 downto 0);
        PORTA_out, B_alarme_out
    );
...
begin
    control : controladora port map (CLOCK => clk, s_porta => S_porta, s_andar => S_andar, r0_in => fio_r0Q, 
                                    r1_in => fio_r1Q, r2_in => fio_r2Q, b_abre => B_abre, b_fecha => b_fecha,
                                    temp => fio_T, porta => fio_porta, temp_cnt => fio_cnt, load_m => fio_load_m,
                                    r0out => fio_r0, r1out => fio_r1, r2out => fio_r2, r_sel => fio_mux,
